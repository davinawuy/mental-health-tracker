...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://alano-davin-mentalhealthtrackerr.pbp.cs.ui.ac.id", "https://alano-davin-mentalhealthtrackerr.pbp.cs.ui.ac.id"]
